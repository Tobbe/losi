...
LangString PROFILES_DAS ${LANG_ENGLISH} "In $APPDATA\Litestep\. This is where programs usually install user-specific files. But they are a pain to get to if you ever need to change anything."
LangString PROFILES_LSPROFILES ${LANG_ENGLISH} "In $INSTDIR\Profiles. This is the recomended option if you want user profiles."
LangString PROFILES_NOPROFILES ${LANG_ENGLISH} "I'm the only LS user on this computer, or all LS users use the same settings. No support for profiles will be added. Files will be installed to $INSTDIR\personal and $INSTDIR\themes"
...
LangString PROFILES_DAS ${LANG_SWEDISH} "I $APPDATA\Litestep\. Detta är var program vanligtvis sparar användarspecifika filer. Men de är jobbiga att komma till om man vill ändra något någon gång."
LangString PROFILES_LSPROFILES ${LANG_SWEDISH} "I $INSTDIR\Profiles. Detta är det rekomenderade valet om du vill ha användarprofiler."
LangString PROFILES_NOPROFILES ${LANG_SWEDISH} "Jag är den enda LS-användaren på den här datorn, eller använder alla samma inställningar. Inget stöd för profiler kommer att installeras. Filer kommer att installeras till $INSTDIR\personal och $INSTDIR\themes"
...
LangString NAME_SecTheme ${LANG_FRENCH} "Thème"
...
LangString TEXT_IO_TITLE_PREVINST ${LANG_FRENCH} "Une installation précédente de Litestep à été détectée"
...
LangString PROFILES_DAS ${LANG_FRENCH} "Dans le dossier $APPDATA\Litestep\: c'est généralement l'endroit où sont stockés les fichiers propres à chaque utilisateur, toutefois, il est souvent fastidieux de les atteindre pour aller les modifier."
LangString PROFILES_LSPROFILES ${LANG_FRENCH} "Dans $INSTDIR\Profiles. Option recommandée si vous souhaitez utiliser des profils utilisateurs."
LangString PROFILES_NOPROFILES ${LANG_FRENCH} "Je suis le seul utilisateur de LS sur ce PC, ou, tous les utilisateurs de LS emploient les mêmes configurations. Le support des profils sera désactivé. Les fichiers seront stockés dans $INSTDIR\personal et $INSTDIR\themes."
...
LangString PREVINST_TEXT ${LANG_FRENCH} "Il semble que Litestep soit déjà installé sur votre ordinateur. Si vous faites une mise à jour depuis une installation précédente de Losi, Litestep ou d'une autre distribution, vous devez choisir d'installer au même endroit que l'ancienne installation de Litestep. Sinon, désinstallez s’il vous plaît votre Distribution Litestep et puis relancez cet installateur"
LangString PREVINST_CHECKBOX ${LANG_FRENCH} "Continuer l'installation dans le répertoire sélectionner ($INSTDIR)"
...
LangString PROFILES_DAS ${LANG_GERMAN} "In $APPDATA\Litestep\. Dort speichern Programme normalerweise Benutzerspezifische Dateien. Es ist allerdings etwas umständlicher an die Dateien zu gelangen."
LangString PROFILES_LSPROFILES ${LANG_GERMAN} "Unter $INSTDIR\Profiles. Das ist die empfohlene Einstellung falls Sie Benutzerprofile nutzen wollen."
LangString PROFILES_NOPROFILES ${LANG_GERMAN} "Sie sind der einzige LiteStep Benutzer an diesem Computer, oder alle LiteStep Benutzer greifen auf die gleichen Eistellungen zu. Benutzerprofile entfallen. Dateien werden in $INSTDIR\personal und $INSTDIR\themes erstellt"
