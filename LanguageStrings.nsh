...
LangString UNINSTALL_LOGMISSING ${LANG_ENGLISH} "${UninstLog} not found! $\r$\nUninstallation cannot proceed!"
...
LangString UNINSTALL_LOGMISSING ${LANG_SWEDISH} "${UninstLog} kunde inte hittas! $\r$\nAvinstallationen kan inte fortsätta!"
LangString UNINSTALL_SUCCESS ${LANG_SWEDISH} "Avinstallationen av ${PRODUCT_NAME} utfördes utan problem."
LangString UNINSTALL_CONFIRM ${LANG_SWEDISH} "Är du säker på att du vill avinstallera ${PRODUCT_NAME} med tillhörande komponenter?"
...
LangString UNINSTALL_LOGMISSING ${LANG_FRENCH} "${UninstLog} ... $\r$\n..."
LangString UNINSTALL_SUCCESS ${LANG_FRENCH} "${PRODUCT_NAME} ..."
LangString UNINSTALL_CONFIRM ${LANG_FRENCH} "... ${PRODUCT_NAME} ..."
...
LangString UNINSTALL_LOGMISSING ${LANG_GERMAN} "${UninstLog} ... $\r$\n..."
LangString UNINSTALL_SUCCESS ${LANG_GERMAN} "${PRODUCT_NAME} ..."
LangString UNINSTALL_CONFIRM ${LANG_GERMAN} "... ${PRODUCT_NAME} ..."
