...
LangString DESC_SecFileAssoc ${LANG_FRENCH} "Configurer les associations de fichier spécifique à LiteStep avec les programmes appropriés (Possibilité de choisir quel types de fichiers seront associés)"
...
LangString TEXT_IO_EVARS ${LANG_FRENCH} "Spécifiez le chemin pour chacune de vos applications. Ceci constituera des raccourcis pour les thèmes."
...
LangString TEXT_IO_TITLE_WHEREPROFILES ${LANG_FRENCH} "Où placer vos profils utilisateurs ?"
...
LangString TEXT_LOGOFF ${LANG_FRENCH} "La session doit être redémarré pour compléter l'installation; reconnecter vous alors avec le même utilisateur.\r\nCette opération est nécessaire pour que Windows prenne en compte les nouvelles valeurs du registre."
...
LangString INSTALL_NOSHELL ${LANG_FRENCH} "Ne pas utiliser LiteStep comme shell par defaut"
...
LangString FILEASSOC_LSZ ${LANG_FRENCH} ".lsz (Thèmes LiteStep compressés) exécutera SLI-ThemeManager"
...
LangString FILEASSOC_LUA ${LANG_FRENCH} ".lua (Scripts Lua, souvent utilisé dans LiteStep) associé à votre éditeur de texte"
...
LangString MB_FOUND_LS_UNINST ${LANG_FRENCH} "Litestep va maintenant être déchargé afin d'effacer les fichiers encore chargé. Si ce n'est pas le cas, merci de le faire manuellement en utilisant la combinaison de touche ctrl-alt-F1 (Quitter... / Forcer...), ou a l'aide du Gestionnaire de Tâches. Ensuite validez par OK."
LangString FINISH_LOGOFF ${LANG_FRENCH} "Je veut fermer la session"
