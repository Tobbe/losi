...
LangString TEXT_IO_FILEASSOC ${LANG_ENGLISH} "$\"Text editor$\" will be whatever you selected as Text editor in the evar configuration."
...
LangString FILEASSOC_LSZ ${LANG_ENGLISH} ".lsz (Compressed LiteStep themes) with Litestep Opensource Theme Switcher"
...
LangString FILEASSOC_LSZ ${LANG_SWEDISH} ".lsz (Packade LiteStep-teman) med Litestep Opensource Theme Switcher"
...
LangString TEXT_IO_FILEASSOC ${LANG_GERMAN} "$\"Text editor$\" steht für das Programm das Sie unter den Umgebungsvariablen dafür angegeben haben."
...
LangString FILEASSOC_LSZ ${LANG_GERMAN} ".lsz (Komprimierte LiteStep Themes) mit dem LOSI Theme Switcher"
