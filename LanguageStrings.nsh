...
LangString TEXT_IO_TITLE_PREREQ ${LANG_FRENCH} "Prerequisites"
LangString TEXT_IO_PREREQ ${LANG_FRENCH} "Make sure all prerequisites are met before continuing."
...
LangString PRE_REQ_NEEDED ${LANG_FRENCH} "The following items needs to be installed on your system before you can install $(^Name)"
LangString PRE_REQ_GOOD ${LANG_FRENCH} "The following items are not needed but they are recomended. If you don't have them it's recomended to install them. This can be done after you have installed $(^Name)"
LangString PRE_REQ_GTEIE4 ${LANG_FRENCH} "Internet Explorer 4 or greater"
...
LangString PRE_REQ_URLTEXT ${LANG_FRENCH} "Find download links to anything you might be missing at:"
...
LangString TEXT_IO_TITLE_PREREQ ${LANG_GERMAN} "Prerequisites"
LangString TEXT_IO_PREREQ ${LANG_GERMAN} "Make sure all prerequisites are met before continuing."
...
LangString PRE_REQ_NEEDED ${LANG_GERMAN} "The following items needs to be installed on your system before you can install $(^Name)"
LangString PRE_REQ_GOOD ${LANG_GERMAN} "The following items are not needed but they are recomended. If you don't have them it's recomended to install them. This can be done after you have installed $(^Name)"
LangString PRE_REQ_GTEIE4 ${LANG_GERMAN} "Internet Explorer 4 or greater"
...
LangString PRE_REQ_URLTEXT ${LANG_GERMAN} "Find download links to anything you might be missing at:"
