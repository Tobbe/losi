...
LangString PROFILES_DAS ${LANG_ENGLISH} "In $PROFILE. This is where programs usually install user-specific files. But they are a pain to get to if you ever need to change anything."
LangString PROFILES_LSPROFILES ${LANG_ENGLISH} "In $INSTDIR\Profiles\$username. This is the recomended option if you want user profiles."
...
LangString PROFILES_DAS ${LANG_SWEDISH} "I $PROFILE. Detta är var program vanligtvis sparar användarspecifika filer. Men de är jobbiga att komma till om man vill ändra något någon gång."
LangString PROFILES_LSPROFILES ${LANG_SWEDISH} "I $INSTDIR\Profiles\$username. Detta är det rekomenderade valet om du vill ha användarprofiler."
...
LangString PROFILES_DAS ${LANG_FRENCH} "Dans le dossier $PROFILE: c'est généralement l'endroit où sont stockés les fichiers propres à chaque utilisateur, toutefois, il est souvent fastidieux de les atteindre pour aller les modifier."
LangString PROFILES_LSPROFILES ${LANG_FRENCH} "Dans $INSTDIR\Profiles\$username. Option recommandée si vous souhaitez utiliser des profils utilisateurs."
...
LangString PROFILES_LSPROFILES ${LANG_GERMAN} "Unter $INSTDIR\Profiles\$username. Das ist die empfohlene Einstellung falls Sie Benutzerprofile nutzen wollen."
